...
const hata2 = () => {
  section.innerHTML = `<h2>You have already entered the same value, you need to enter a different value</h2>`;
  // section.style.color = "red";
  section.setAttribute(
    "style",
    "margin-left: 7%; margin-top: 1rem; color: red;"
  );
  setTimeout(() => {
    section.innerHTML = "";
  }, 4000);
...
const hata = () => {
  section.innerHTML = `<h2>Are you sure you spelled the coin name correctly?</h2>`;
  // section.style.color = "red";
  section.setAttribute(
    "style",
    "margin-left: 7%; margin-top: 1rem; color: red;"
